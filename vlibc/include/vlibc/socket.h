 ...
 * (41..48). Client and server: socket/connect/send/recv/close plus
 * bind/listen/accept for inbound connections. IP addresses are big-endian
 * uint32s (10.0.2.2 = 0x0A000202); ports are host byte order. Socket
 * handles are small integers, not VFS fds.
 *
